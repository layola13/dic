```json
{
  ...
  "translation": "什么",
  "definition": "Used to ask for information about someone or something; which thing(s); how great or remarkable.",
...
```
Based on the data I found, here's a breakdown of the word "what" in JSON format:

*   **General Information**: Includes the word, its phonetic transcription, parts of speech, translation, definition, synonyms, and antonyms.
*   **Usage**: Demonstrates the use of "what" in different tenses (simple present, present continuous, present perfect, etc.), moods (subjunctive), voices (passive), and sentence types (interrogative, negative) with example sentences and their translations.
*   **Phrases**:  Lists common phrases and idioms using "what", along with their translations, to help understand its practical application.
