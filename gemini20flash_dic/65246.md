```json
{
  ...
  "translation": "什么",
  "etymology": {
    "origin": "Old English hwæt, from Proto-Germanic *hwat (neuter of *hwas 'who'), from PIE root *kwo-, relative pronoun and interrogative base.",
    "historical_details": [
      {
        "period": "Old English",
        "info": "In Old English, 'hwæt' was used as both an interrogative pronoun and an adverbial particle indicating degree or manner. It was also used as an interjection to express surprise or to call attention."
      },
      {
        "period": "Middle English",
        "info": "The form and usage of 'what' remained largely unchanged through the Middle English period. It continued to function as a versatile word for inquiry and exclamation."
      },
      {
        "period": "Modern English",
        "info": "In Modern English, 'what' has retained its core functions and expanded into various idiomatic expressions and complex grammatical structures. Its flexibility allows it to be used in a wide range of contexts, from simple questions to complex clauses."
      }
    ],
    "semantic_evolution": [
      {
        "stage": "Proto-Indo-European",
        "meaning": "The root *kwo- served as the base for relative pronouns and interrogatives, indicating a fundamental concept of inquiry and relation."
      },
      {
        "stage": "Proto-Germanic",
        "meaning": "The neuter form *hwat specified the inquiry towards inanimate objects or abstract concepts, distinguishing it from *hwas, which referred to persons."
      },
      {
        "stage": "Old English to Present",
        "meaning": "Over time, 'what' maintained its role as an interrogative and relative pronoun, while also developing uses as an adjective, adverb, and interjection. Its semantic range broadened to include various nuances of inquiry, surprise, and emphasis."
      }
    ],
    "related_words": [
      {
        "word": "who",
        "relationship": "Shares the same Proto-Indo-European root *kwo-, but refers to persons rather than things or concepts."
      },
      {
        "word": "how",
        "relationship": "Also related through the Proto-Indo-European root, indicating manner or degree."
      },
      {
        "word": "that",
        "relationship": "Functions similarly as a relative pronoun, often interchangeable with 'what' in certain contexts."
      }
    ]
  },
