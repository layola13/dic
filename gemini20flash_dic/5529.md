```json
{
  ...
  "etymology": "From Old English hwæt, from Proto-Germanic *hwat.",
  ...
  "idioms": [
    ...
    {
      "expression": "what if",
      "meaning": "What will happen if?",
      "example": "What if it rains tomorrow?"
    },
     {
      "expression": "what about",
      "meaning": "An expression used to make a suggestion or offer.",
  ...
  "phrases": {
    "common": [
      ...
      },
      {
        ...
        "meaning": "An expression of surprise, anger, or frustration.",
