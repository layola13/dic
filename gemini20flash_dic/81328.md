  ...
  "graphemes": [
    {
      "letter": "w",
      "phoneme": "/w/",
      "description": "The letter 'w' typically represents the /w/ sound, which is a voiced labio-velar approximant. It's formed by rounding the lips and raising the back of the tongue towards the velum."
    },
    {
      "letter": "h",
      "phoneme": "silent",
      "description": "In the word 'what', the letter 'h' is silent. This is a common feature in English where 'h' following 'w' is not pronounced, especially in question words."
    },
    {
      "letter": "a",
      "phoneme": "/ɑː/",
      "description": "The letter 'a' in 'what' represents the broad 'a' sound /ɑː/, which is an open back unrounded vowel. It's produced by opening the mouth wide and positioning the tongue low and back."
    },
    {
      "letter": "t",
      "phoneme": "/t/",
      "description": "The letter 't' represents the /t/ sound, which is a voiceless alveolar stop. It's produced by blocking the airflow with the tongue against the alveolar ridge and then releasing it."
    }
  ],
  "phonetics": "/wɑːt/",
