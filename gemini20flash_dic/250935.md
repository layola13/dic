```json
{
  ...
  "translation": "什么",
  "definition": "Used to ask for information about someone or something; which thing(s) (used when requesting specific information).",
...
```
Here is a detailed breakdown of the word "what" in JSON format. I've included the phonetic transcription, parts of speech, translation, definition, example sentences, synonyms, antonyms, common usages in different tenses, and example phrases and idioms.
