```json
{
  "word": "what",
  "phonetics": "/wɑːt/",
  "part_of_speech": "pron., det., excl., adv., (pre-determiner)",
  "translation": "什么",
...
```
Here's a breakdown of the word "what" in JSON format, covering its phonetics, parts of speech, translations, definitions, example sentences, synonyms, antonyms, and common usages in different tenses and sentence structures. Additionally, I've included common phrases and idioms using "what."
