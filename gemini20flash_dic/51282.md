```json
{
  "word": "what",
  "phonetics": "/wɑːt/",
  "part_of_speech": "pron., det., adj., adv., conj.",
  "translation": "什么",
  "definition": "Used to ask for information about someone or something; which thing(s) or person(s) (used interrogatively).",
...
```
Here's a detailed JSON breakdown of the word "what," including its phonetics, parts of speech, translations, definitions, examples, synonyms, antonyms, and usage in various tenses, moods, and sentence structures. I've also included common phrases and idioms using "what."
