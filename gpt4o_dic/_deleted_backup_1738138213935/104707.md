...
This format provides a comprehensive understanding of the word "what," illustrating its usage in different grammatical contexts along with examples and translations. 