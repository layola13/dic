llds 不是一个标准的英文单词。 你可能是想查询 LLDS（Low-Level Data Streaming）或者其他缩写。 请提供正确的单词或缩写。

以下是用 hello 为例的格式示范，请提供正确的单词以便我按照格式生成答案：

hello:/həˈloʊ/ (US) /hɛˈləʊ/ (UK)| int. n. vt.| 你好；问候语 |Used as a greeting or to begin a phone conversation.  |Hello, how are you? 你好，你好吗？| Hi, hey | Goodbye, farewell | interjection, noun, verb
