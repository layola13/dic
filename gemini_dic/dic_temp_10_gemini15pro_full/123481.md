monosyllabically:/ˌmɒnəsɪˈlæbɪkli/ | adv. | 单音节地 | In a way that uses only single-syllable words. | He answered monosyllabically, clearly unwilling to engage in conversation. 他只用单音节词回答，显然不愿参与对话。 |  Example 2:  She spoke monosyllabically, making it difficult to understand her feelings. 她说话只用单音节词，很难理解她的感受。 | 近义词: tersely, shortly | 反义词: verbosely, polysyllabically | 词性: 副词


Etymology:
From mono- (one) + syllable + -ically (adverbial suffix).  Ultimately from Greek monos (single) and syllabē (syllable).
