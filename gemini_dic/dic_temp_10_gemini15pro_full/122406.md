mnemonically:/nɪˈmɒnɪkli/ | adv. | 记忆地，助记地 |  By using a mnemonic device, like associating the word with a vivid image, one can remember it more easily. 通过使用助记装置，例如将单词与生动的图像关联，可以更容易地记住它。| She mnemonically linked the name with the face. 她巧妙地把名字和脸联系起来。 | synonym: memorably, by rote | antonym: forgetfully | adverb
...
词源: From Greek *mnēmōn-, *mnā- ‘mindful’  来自希腊语 *mnēmōn-, *mnā- ‘留心的’
