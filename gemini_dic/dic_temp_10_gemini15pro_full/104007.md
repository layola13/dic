"jui" 不是一个标准的英语单词。可能是一个拼写错误，俚语，或来自其他语言。 请提供更多上下文或更正拼写，以便我提供准确的信息。


如果你是想查询 "what" 这个单词，我可以提供以下信息：

what: /wɒt/ (UK) /wʌt/ (US) | pron. det. adv. int.| 什么，多么 | Used to ask for information about something.  | What is your name? 你叫什么名字？ | What a beautiful day! 多么美好的一天！ | similar: which, how | opposite: N/A | pronoun, determiner, adverb, interjection
