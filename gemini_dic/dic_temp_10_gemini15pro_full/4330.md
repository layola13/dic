aka:/ˌeɪ keɪ ˈeɪ/ | abbreviation | 又名；亦称 | also known as (used when giving someone's real name after a nickname or stage name) | Example: Bruce Wayne, aka Batman, is a fictional superhero. 布鲁斯·韦恩，又名蝙蝠侠，是一位虚构的超级英雄。| Example: My friend, aka "The Brain," is incredibly intelligent. 我的朋友，又名“大脑”，非常聪明。 | Synonym: alias, also called, otherwise known as | Antonym: N/A | abbreviation
...
注意事项:  *aka* itself doesn't have different tenses or conjugations as it's an abbreviation. The verb tenses apply to the sentence in which *aka* is used.
