alphamerically: /ˌælfəˈmɛrɪkli/ | adv. | 按字母顺序地 | Arranged in alphabetical order. |  The words are listed alphamerically.  这些单词是按字母顺序排列的。 | alphabetically |  non-alphabetically | adverb
...
词源：来源于古英语 hwæt,  意思是"什么"。  它是一个疑问代词，用于询问事物、情况或信息。
