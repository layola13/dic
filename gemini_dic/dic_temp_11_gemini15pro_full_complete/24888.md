bruh:/brʌ/| interjection|哥们，伙计；(表示惊讶、不相信等)|An informal greeting or exclamation, often expressing surprise, disbelief, or annoyance.|Bruh, you serious? 哥们，你是认真的吗？|近义词：dude, man, bro|反义词: (无明确的反义词，取决于bruh表达的具体含义)|感叹词
...
词源:  Bruh is a slang term thought to have originated in African American Vernacular English (AAVE). It's a variant of "bro," short for "brother."  Its popularization is largely attributed to online platforms like Twitch and YouTube.


注意事项:  While bruh is widely used, it's considered informal and best suited for casual conversations amongst friends.  Avoid using it in formal settings.